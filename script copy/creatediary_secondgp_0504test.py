...
tasklist = [
    ("男友共同做的研究部分，有氫原子模型的畫圖要做，有FEM，有FEM要學。找到人寫的完整的氫原子模型，已有部分code，但先熟悉數學。已經開始有點感覺了。", datetime(2024, 1, 23)), 
    ("H大合作的切片影像分析企劃，已經交了第一批切片給他訓練。", datetime(2024, 1, 23)), 
    ("加拿大鮮肉合作的文字分析企劃，已經交出了第二批指示。", datetime(2024, 1, 23)),
